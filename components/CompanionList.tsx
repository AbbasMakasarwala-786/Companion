          ...
          {companions?.map((companion) => (
            <TableRow key={companion.id}>
              ...
              <TableCell>
                ...
                <div className='flex items-center justify-center rounded-lg md:hidden w-fit p-2' style={{backgroundColor:getSubjectColor(companion.subject)}}>
                 <Image src={`/icons/${companion.subject}.svg`} alt={companion.subject} height={18} width={18}/> 
                </div>
              </TableCell>
